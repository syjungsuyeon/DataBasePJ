...
{
    21,
    "update_transaction.pc"
};


static unsigned int sqlctx = 168054683;
...
{13,4130,1,0,0,
5,0,0,1,0,0,24,107,0,0,1,1,0,1,0,1,97,0,0,
24,0,0,2,0,0,29,109,0,0,0,0,0,1,0,
39,0,0,3,0,0,17,150,0,0,1,1,0,1,0,1,97,0,0,
58,0,0,3,0,0,45,154,0,0,0,0,0,1,0,
73,0,0,3,0,0,13,159,0,0,5,0,0,1,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,2,9,0,0,
108,0,0,3,0,0,15,172,0,0,0,0,0,1,0,
};
...
void ut_Select_tuple()
{
    ...
    /* varchar v_bn[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_bn;

    /* varchar v_dn[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_dn;

    /* varchar v_pn1[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_pn1;

    /* varchar v_pc[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_pc;

    /* varchar v_pr[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_pr;

    /* varchar v_ed[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_ed;

    /* varchar v_tc[100]; */ 
struct { unsigned short len; unsigned char arr[100]; } v_tc;
